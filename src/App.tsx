      ...
      <main className="game bg-office startScreen">
        ...
        <section className="startCard">
          ...
          <p className="startText">
            Գյուղական գործը թվում էր շատ պարզ․ ոչխար, մեղադրանք, ցուցմունք, անուններ, դատարան։ Բայց այս պատմության մեջ
            իրական հարցաքննությունը սկսվում է այն պահին, երբ գյուղացիները փորձում են ծաղրել լեյտենանտին։ Իսկ լեյտենանտը չէր կարող այդ հանդուրժել։
          </p>
          <p className="startNote">
            Դու չես խաղում պարզապես «չար» մարդու դերը։ Դու խաղում ես այն մարդու դերը, որը փորձում է չերևալ թույլ։
          </p>
